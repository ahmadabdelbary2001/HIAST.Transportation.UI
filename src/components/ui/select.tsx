...
>(({ className, children, position = "popper", ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ref={ref}
      className={cn(
        "relative z-50 max-h-96 min-w-[8rem] overflow-hidden rounded-md border p-1 shadow-md",
        // --- Style Integration from DropdownMenu ---
    ...
    >
      ...
      <SelectPrimitive.Viewport
        className={cn(
          "p-1", // Keep the padding for the viewport
          position === "popper" &&
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    // --- Style Integration from DropdownMenu ---
    className={cn("py-1.5 pl-8 pr-2 text-sm font-semibold text-[var(--theme-sidebar-text)]", className)}
    {...props}
  />
))
